...
vals = [f for f in listdir(temp_path) if "germline_SNVs_VCF_RNA_VAF_" in f and "LMSU" in f]
KS_pval = []
...
for www in vals:
    ...
    df.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/CCLE/ASE/Data_Germline_CSVs/" + www + "_AF_vs_position.csv", index=False)
...
#/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/sTFE/ASE_on_hets_merged/ASE_plots
    ...
    fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/CCLE/ASE/Data_Germline_CSVs/" + www + "_AF_vs_position.pdf", dpi=dpi_set, bbox_inches = 'tight')

...
for www in vals:
    ...
    df.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/TCGA/unpaired_RNAseq_ccRCCs_plots/TRUNCATED_withoutVline_" + www + "_AF_vs_position.csv", index=False)
    ...
    fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/TCGA/unpaired_RNAseq_ccRCCs_plots/" + www + "_AF_vs_position.pdf", dpi=dpi_set, bbox_inches = 'tight')

...
temp_path = "/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/WGS/RNAseq_paired_all_chr/"
vals = [f for f in listdir(temp_path) if "allchr_RNA_paired_on_germline_hets_unphased_" in f and "18" in f]
KS_pval = []
distal_vals_total = []
prox_vals_total = []

id_list = ['18','11','6','DTRCC8','10','11','17']
fusion_partner = ['SFPQ','PRCC','SFPQ','ASPSCR1','MED15','PRCC','PRCC']
fusion_chromosome = ['chr1','chr1','chr1','chr17','chr22','chr1','chr1']
fusion_location = [35176378,156800815,35176378,82017406,20587632,156800815,156800815]
temp_length = [248956422,248956422,248956422,83257441,50818468,248956422,248956422]
...
for www in vals:
    ...
    value = www.split("allchr_RNA_paired_on_germline_hets_unphased_")[1].split(".log")[0]
    temp_chr = "chrX"
    try:
        temp_id = str(value.split("CC_")[-1].split("CC")[-1].split("_")[0])
    except:
        temp_id = ""
    if "LiverTum_2" in www:
        temp_id = "18"
    if temp_id == str(8):
        temp_id = "DTRCC8"
    ...
    if "18" in str(temp_id):
        path1 = "/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/WGS/Xi_Xa_fusion/BTRCC18_phased/chr1_het_eagle2phased.vcf.gz"
    ...
    temp_file = temp_path + temp_chr + www[6:]
    ...
    if "18" in str(temp_id):
        ...
        df_af = df_abs_cn[df_abs_cn['contig']=="hs1"]
    ...
    axs[2,1].set_ylim([-0.01, 7.01]) 
    axs[2,1].set_yticks([0, 1, 2, 3, 4, 5, 6, 7]) 
    axs[2,1].set_yticklabels([0, 1, 2, 3, 4, 5, 6, 7]) 

    if "18" in str(temp_id) or "17" in str(temp_id):
        sub_cn_df = pd.DataFrame([[temp_chr],[0],[temp_length],[2]]).T
    ...
    sub_cn_df = sub_cn_df[sub_cn_df['Chromosome'].isin([temp_chr])]
    ...
    fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/WGS/RNAseq_tophat_paired_plots/fusionPARTNER_" + www + "_AF_vs_position.pdf", dpi=dpi_set, bbox_inches = 'tight')
...
df_out.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/TCGA/ASE_summary/WGS_translocated_autosome_KS_test.csv")
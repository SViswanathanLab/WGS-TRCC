...
**Fixes Error:** RangedData objects are deprecated and the coercion method from data.frame or DataTable to RangedData is now defunct. Please migrate your code to use GRanges or GRangesList objects instead

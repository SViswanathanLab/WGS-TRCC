...
all_valid_pos = list(set(all_valid_pos))
dflist = [df_AK3444,df_BP4983,df_B04818,df_B05110,df_B85552,df_CZ4863,df_G6A8L7,df_G6A8L8,df_T7A92I]
#dfvals = ['6D-AA2E','B0-5705','B8-5546','BP-4756','AK-3444','BP-4983','B0-4818','B0-5110','B8-5552','CZ-4863','G6-A8L7','G6-A8L8','T7-A92I']
dfvals = ['AK-3444','BP-4983','B0-4818','B0-5110','B8-5552','CZ-4863','G6-A8L7','G6-A8L8','T7-A92I']
xa_betas1 = []
...
all_valid_pos = list(set(all_valid_pos))
dflist = [df_6DAA2E,df_B05705,df_B85546,df_BP4756]
dfvals = ['6D-AA2E','B0-5705','B8-5546','BP-4756']
xa_betas2 = []
...
master_df = pd.DataFrame([biallelic_betas,xa_betas2]).T
col_names = ['Xi tRCCs','Xa tRCCs']
master_df.columns = col_names

x,y = scipy.stats.mannwhitneyu([float(x) for x in biallelic_betas], [float(x) for x in xa_betas2], alternative="two-sided")
print(x)
print(y)
...
add_stat_annotation(ax, data=master_df,
    ...
    test='Mann-Whitney', text_format='full', loc='outside', verbose=2, text_offset=0.01, line_offset_to_box=(x)/20, line_offset=0.18)
...
fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/methylation_new/methylation_by_Xi_vs_Xa_no_ccRCC_plot.pdf", dpi=dpi_set, bbox_inches = 'tight')    

...
temp_path = "/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/sTFE/ASE_on_hets_merged/"
vals = [f for f in listdir(temp_path) if "all_chr_on_germline_hets_unphased_" in f]
KS_pval = []
...
for www in vals:
    ...
    sd_cutoff = 1
    print("reading VCF")
    path1 = "/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/sTFE/ASE_on_hets_raw/A4_CKDN230014515_rg_hg38_sorted_picard_filtered.vcf.gz"
    ...
    df.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/sTFE/ASE_plots/" + www + "_AF_vs_position.csv", index=False)
    ...
    df_cnnew = pd.read_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/sTFE/A4_CKDN230014515_dnacopy.seg", sep="\t")
...
#/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/sTFE/ASE_on_hets_merged/ASE_plots
    ...
    fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/sTFE/ASE_plots/" + www + "_AF_vs_position.pdf", dpi=dpi_set, bbox_inches = 'tight')

df_out = pd.DataFrame([vals, KS_pval]).T
df_out.columns = ['Sample', 'pval_KS']
df_out.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/sTFE/ASE_plots/unpaired_RNAseq_TCGA_XR_summary_all_samples_KS_test_temp.csv")

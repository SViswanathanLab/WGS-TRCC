...
for www in vals:
    ...
    axs[3,1].set_ylabel("Allele Fraction (RNA, Primary)", labelpad=5)
    axs[2,1].set_ylabel("Allele Fraction (DNA, Primary)", labelpad=5)
    ...
    fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/WGS/Xi_Xa_fusion/BTRCC18_phased/" + www + "_AF_vs_position_chrX_no_CN.pdf", dpi=dpi_set, bbox_inches = 'tight')

df_out = pd.DataFrame([vals, KS_pval]).T
df_out.columns = ['Sample', 'pval_KS']
df_out.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/WGS/Xi_Xa_fusion/BTRCC18_phased/BTRCC18_XR_summary_KS_test_NEW_paired.csv")

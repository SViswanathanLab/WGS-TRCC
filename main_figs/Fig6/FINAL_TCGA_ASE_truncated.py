...
temp_path = "/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/TCGA/unpaired_RNAseq/"
vals = [f for f in listdir(temp_path) if "RNA_unpaired_on_germline_hets_unphased_" in f]
KS_pval = []

#Iterate over each file
for www in vals:
    value = www.split("chrX_RNA_unpaired_on_germline_hets_unphased_")[1].split(".log")[0]
    try:
    ...
    df.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/TCGA/unpaired_RNAseq_plots/TRUNCATED_withoutVline_" + www + "_AF_vs_position.csv", index=False)
    ...
    fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/TCGA/unpaired_RNAseq_plots/TRUNCATED_withoutVline_" + www + "_AF_vs_position.pdf", dpi=dpi_set, bbox_inches = 'tight')

#df_out = pd.DataFrame([vals, KS_pval]).T
#df_out.columns = ['Sample', 'pval_KS']
#df_out.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/tRCC_X/TCGA/unpaired_RNAseq_TCGA_XR_summary_all_samples_KS_test_temp.csv")
